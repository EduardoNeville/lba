  ...
  sections: [
    {
      heading: 'Who we are',
      body: [
        'Legal Boutique Advisers, Calle Nuestra Señora de Gracia, 26, bajo, Marbella, Spain. Contact: info@legalboutiqueadvisers.com.',
      ],
    },
    {
...
export const termsDoc: LegalDoc = {
  ...
  sections: [
    ...
    },
    {
      heading: 'Contact',
      body: [
        'Questions about these terms: info@legalboutiqueadvisers.com.',
      ],
    },
  ],
}