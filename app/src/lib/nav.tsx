...
import { nav as navFr, footer as footerFr, ui as uiFr } from '../data/locales/fr'
import { nav as navEs, footer as footerEs, ui as uiEs } from '../data/locales/es'
...
export function useNav() {
  ...
  return NAV.map((item) => {
    const label = dict ? dict.label[item.to.replace('/', '') as keyof typeof dict.label] ?? item.label : item.label
...
export const FOOTER_NAV_KEYS = ['property', 'legal', 'privateClient', 'lifestyle', 'about'] as const
