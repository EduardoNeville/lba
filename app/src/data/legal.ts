...
export const areas = [
  { num: '01', title: 'Real Estate Law', body: 'Comprehensive legal support for the acquisition, ownership and sale of property in Spain.', checks: ['Purchase & Sale', 'Due Diligence', 'Contracts & Negotiation', 'Co-ownership & Development', 'Leases & Tenancy'], image: homeHero, alt: 'Modern villa' },
  { num: '02', title: 'Tax & Structuring', body: 'Tailored tax advice and structuring solutions for individuals, families and their assets.', checks: ['Tax Planning', 'Wealth Structuring', 'Inheritance & Succession', 'Tax Compliance', 'International Mobility'], image: ctaBotanical, alt: 'Botanical detail' },
  { num: '03', title: 'Corporate & Investment', body: 'Legal advice for companies, investors and entrepreneurs operating in or investing in Spain.', checks: ['Company Formation', 'Commercial Contracts', 'M&A & Transactions', 'Shareholders Agreements', 'Regulatory Matters'], image: ctaCoast, alt: 'Coastal view' },
...
export const cta = { heading: 'Need legal advice?', subline: 'We are here to help.', image: ctaCoast }
