...
export const fr = {
  hero: {
    eyebrow: 'À propos',
    title: 'Bâti sur la confiance. Façonné autour de nos clients.',
    body: [
      'Legal Boutique Advisers a été fondé comme un cabinet juridique boutique autour d’un principe simple : chaque client a une situation unique, et les conseils qui lui sont apportés doivent l’être également.',
      ...
      'Notre cabinet a évolué autour de ces besoins.',
  ...
  legacy: {
    ...
    body: [
      'Fondé par l’avocate Marisela Castro Abad, Legal Boutique Advisers ouvre aujourd’hui un nouveau chapitre avec le développement de ses activités de conseil immobilier et de services aux clients privés.',
  ...
  values: [
    ...
    { icon: 'scales', title: 'Indépendante', body: 'Des conseils objectifs, adaptés à vos meilleurs intérêts.' },
...
export const es = {
  hero: {
    eyebrow: 'Nosotros',
    title: 'Construido sobre la confianza. Evolucionando junto a nuestros clientes.',
    body: [
      'Legal Boutique Advisers nació como un despacho jurídico boutique con un principio sencillo: las circunstancias de cada cliente son diferentes y su asesoramiento también debe serlo.',
      ...
      'Nuestro despacho ha evolucionado en torno a esas necesidades.',
  ...
  legacy: {
    ...
    body: [
      'Fundado por la abogada Marisela Castro Abad, Legal Boutique Advisers inicia ahora una nueva etapa con la expansión de su asesoramiento inmobiliario y de servicios para clientes privados.',
  ...
  values: [
    ...
    { icon: 'scales', title: 'Independiente', body: 'Asesoramiento objetivo, adaptado a sus mejores intereses.' },
